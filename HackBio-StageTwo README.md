...
'''  
    ...
    sc.tl.leiden(bone_marrow_adata, flavor="igraph", n_iterations=2, key_added="leiden\_res2", resolution=2)  
...
'''  
    ...
    cluster\_annotations = bone_marrow_adata_rank[bone_marrow_adata_rank["stat"] > 0].groupby("group").head(1).set_index("group")["name"].to_dict()  
...
'''  
    ...
    groupby='leiden', dendrogram=True, color_map='Reds',  
    use_raw=False)  
