...
"""Dimensionality Reduction: Principal Component Analysis, UMAP
Non Linear Dimensionality Reduction: Leiden
"""
...
Hematopoietuc stem and progenitor cells
Myeloic cells

Observed populations: T cells, B cells, Neutrophils, Dendritic cells, Plsma cells and Platelets.
...
Given (A) the absence of erythroid and megakaryocytic clusters, (B) the lack of detectable hematopoietic progenitors (HSC/MPP signatures) on the UMAP, and (C) a cell frequency distribution dominated by mature lymphocytes (T cells ~40–45%) typical of PBMC profiles, the most parsimonious, testable conclusion is that this dataset is not an unsorted bone-marrow sample. The likely explanations are sample misannotation (it is PBMC) or that pre-processing (PBMC isolation) removed marrow-specific compartments.
